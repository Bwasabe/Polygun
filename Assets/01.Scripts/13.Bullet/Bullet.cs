...
public class Bullet : MonoBehaviour, IAtkCallbackable
{
	[SerializeField]
	...
	protected virtual void Awake()
	{
		...
		_collisionCtrl.ColliderEnterEvent += Attack;
	...
	public void Attack(Collider other)
	{
		if (((1 << other.gameObject.layer) & HitLayer) > 0)
		{
			...
			obj.GetComponent<DamagePopUp>().DamageText((int)Damage, other.transform.position);
		}
	}
}
